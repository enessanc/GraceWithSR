...
class TextAttention(nn.Module):
    def __init__(self, num_channels):
        ...
        self.feature_reduce = nn.Sequential(
            nn.Conv2d(num_channels, reduced_channels, kernel_size=1, padding=0),
    ...
    def forward(self, x):
        ...
        # Girişi ağırlıklandır
        enhanced = x * attention

        # Residual bağlantı ekle
        return x + enhanced
